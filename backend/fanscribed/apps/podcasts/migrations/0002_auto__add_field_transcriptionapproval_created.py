...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TranscriptionApproval.created'
        db.add_column(u'podcasts_transcriptionapproval', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TranscriptionApproval.created'
        db.delete_column(u'podcasts_transcriptionapproval', 'created')
