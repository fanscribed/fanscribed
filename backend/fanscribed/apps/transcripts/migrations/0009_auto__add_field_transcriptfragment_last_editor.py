...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sentence.clean_last_editor'
        db.add_column(u'transcripts_sentence', 'clean_last_editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Sentence.boundary_last_editor'
        db.add_column(u'transcripts_sentence', 'boundary_last_editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Sentence.speaker_last_editor'
        db.add_column(u'transcripts_sentence', 'speaker_last_editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TranscriptFragment.last_editor'
        db.add_column(u'transcripts_transcriptfragment', 'last_editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TranscriptStitch.last_editor'
        db.add_column(u'transcripts_transcriptstitch', 'last_editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sentence.clean_last_editor'
        db.delete_column(u'transcripts_sentence', 'clean_last_editor_id')

        # Deleting field 'Sentence.boundary_last_editor'
        db.delete_column(u'transcripts_sentence', 'boundary_last_editor_id')

        # Deleting field 'Sentence.speaker_last_editor'
        db.delete_column(u'transcripts_sentence', 'speaker_last_editor_id')

        # Deleting field 'TranscriptFragment.last_editor'
        db.delete_column(u'transcripts_transcriptfragment', 'last_editor_id')

        # Deleting field 'TranscriptStitch.last_editor'
        db.delete_column(u'transcripts_transcriptstitch', 'last_editor_id')
    ...
    models = {
        ...
        u'transcripts.sentence': {
            ...
            'boundary_last_editor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'clean_last_editor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'speaker_last_editor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['auth.User']"}),
        ...
        u'transcripts.transcriptfragment': {
            ...
            'end': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_editor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['auth.User']"}),
