...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field contributors on 'Transcript'
        m2m_table_name = db.shorten_name(u'transcripts_transcript_contributors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transcript', models.ForeignKey(orm[u'transcripts.transcript'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['transcript_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field contributors on 'Transcript'
        db.delete_table(db.shorten_name(u'transcripts_transcript_contributors'))
