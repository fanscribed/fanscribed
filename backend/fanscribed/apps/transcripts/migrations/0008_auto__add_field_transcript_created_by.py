...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transcript.created_by'
        db.add_column(u'transcripts_transcript', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transcript.created_by'
        db.delete_column(u'transcripts_transcript', 'created_by_id')
