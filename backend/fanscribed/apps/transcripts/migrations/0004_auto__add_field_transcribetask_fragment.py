...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TranscribeTask.fragment'
        db.add_column(u'transcripts_transcribetask', 'fragment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transcripts.TranscriptFragment'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TranscribeTask.fragment'
        db.delete_column(u'transcripts_transcribetask', 'fragment_id')
