...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BoundaryTask.presented_at'
        db.add_column(u'transcripts_boundarytask', 'presented_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BoundaryTask.validated_at'
        db.add_column(u'transcripts_boundarytask', 'validated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpeakerTask.presented_at'
        db.add_column(u'transcripts_speakertask', 'presented_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpeakerTask.validated_at'
        db.add_column(u'transcripts_speakertask', 'validated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StitchTask.presented_at'
        db.add_column(u'transcripts_stitchtask', 'presented_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StitchTask.validated_at'
        db.add_column(u'transcripts_stitchtask', 'validated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CleanTask.presented_at'
        db.add_column(u'transcripts_cleantask', 'presented_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CleanTask.validated_at'
        db.add_column(u'transcripts_cleantask', 'validated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TranscribeTask.presented_at'
        db.add_column(u'transcripts_transcribetask', 'presented_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TranscribeTask.validated_at'
        db.add_column(u'transcripts_transcribetask', 'validated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BoundaryTask.presented_at'
        db.delete_column(u'transcripts_boundarytask', 'presented_at')

        # Deleting field 'BoundaryTask.validated_at'
        db.delete_column(u'transcripts_boundarytask', 'validated_at')

        # Deleting field 'SpeakerTask.presented_at'
        db.delete_column(u'transcripts_speakertask', 'presented_at')

        # Deleting field 'SpeakerTask.validated_at'
        db.delete_column(u'transcripts_speakertask', 'validated_at')

        # Deleting field 'StitchTask.presented_at'
        db.delete_column(u'transcripts_stitchtask', 'presented_at')

        # Deleting field 'StitchTask.validated_at'
        db.delete_column(u'transcripts_stitchtask', 'validated_at')

        # Deleting field 'CleanTask.presented_at'
        db.delete_column(u'transcripts_cleantask', 'presented_at')

        # Deleting field 'CleanTask.validated_at'
        db.delete_column(u'transcripts_cleantask', 'validated_at')

        # Deleting field 'TranscribeTask.presented_at'
        db.delete_column(u'transcripts_transcribetask', 'presented_at')

        # Deleting field 'TranscribeTask.validated_at'
        db.delete_column(u'transcripts_transcribetask', 'validated_at')
    ...
    models = {
        ...
        u'transcripts.boundarytask': {
            ...
            'presented_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'validated_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
