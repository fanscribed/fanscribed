...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sentence.clean_lock_id'
        db.add_column(u'transcripts_sentence', 'clean_lock_id',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sentence.boundary_lock_id'
        db.add_column(u'transcripts_sentence', 'boundary_lock_id',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sentence.speaker_lock_id'
        db.add_column(u'transcripts_sentence', 'speaker_lock_id',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TranscriptFragment.lock_id'
        db.add_column(u'transcripts_transcriptfragment', 'lock_id',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TranscriptStitch.lock_id'
        db.add_column(u'transcripts_transcriptstitch', 'lock_id',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sentence.clean_lock_id'
        db.delete_column(u'transcripts_sentence', 'clean_lock_id')

        # Deleting field 'Sentence.boundary_lock_id'
        db.delete_column(u'transcripts_sentence', 'boundary_lock_id')

        # Deleting field 'Sentence.speaker_lock_id'
        db.delete_column(u'transcripts_sentence', 'speaker_lock_id')

        # Deleting field 'TranscriptFragment.lock_id'
        db.delete_column(u'transcripts_transcriptfragment', 'lock_id')

        # Deleting field 'TranscriptStitch.lock_id'
        db.delete_column(u'transcripts_transcriptstitch', 'lock_id')
