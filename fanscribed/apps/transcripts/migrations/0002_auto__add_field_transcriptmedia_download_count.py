...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TranscriptMedia.download_count'
        db.add_column(u'transcripts_transcriptmedia', 'download_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TranscriptMedia.download_count'
        db.delete_column(u'transcripts_transcriptmedia', 'download_count')
