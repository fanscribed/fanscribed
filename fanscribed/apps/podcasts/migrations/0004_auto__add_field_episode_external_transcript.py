...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Episode.external_transcript'
        db.add_column(u'podcasts_episode', 'external_transcript',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Episode.external_transcript'
        db.delete_column(u'podcasts_episode', 'external_transcript')
