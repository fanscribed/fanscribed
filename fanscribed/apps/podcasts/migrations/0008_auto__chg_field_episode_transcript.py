...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Episode.transcript'
        db.alter_column(u'podcasts_episode', 'transcript_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['transcripts.Transcript'], unique=True))

    def backwards(self, orm):

        # Changing field 'Episode.transcript'
        db.alter_column(u'podcasts_episode', 'transcript_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['transcripts.Transcript']))
