...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Podcast.provides_own_transcripts'
        db.add_column(u'podcasts_podcast', 'provides_own_transcripts',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Podcast.provides_own_transcripts'
        db.delete_column(u'podcasts_podcast', 'provides_own_transcripts')
