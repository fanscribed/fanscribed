...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Episode.image_url'
        db.add_column(u'podcasts_episode', 'image_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Podcast.image_url'
        db.add_column(u'podcasts_podcast', 'image_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Episode.image_url'
        db.delete_column(u'podcasts_episode', 'image_url')

        # Deleting field 'Podcast.image_url'
        db.delete_column(u'podcasts_podcast', 'image_url')
